...
int main() {
   ...
   // to catch #instruction cache fetch
   perf_set_mask(PERF_COUNTER_2, PERF_INSTRUCTION_FETCH_MASK | PERF_ICACHE_MISS_MASK);
   // to catch #instruction misses
   ...
   perf_print_cycles(PERF_COUNTER_2, "Instruction cache # ");
   perf_print_cycles(PERF_COUNTER_3, "Instruction cache miss # ");
